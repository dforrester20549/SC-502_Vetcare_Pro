...
?>
    ...
    <main> 
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <!-- <a href="../img/gallery/gallery1.png" class="img-pop-up">.. Project</a> -->
                            <div class="gallery-img size-img" style="background-image: url(../img/gallery/gallery1.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(../img/gallery/gallery2.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(../img/gallery/gallery3.png);"></div>
                        </div>
                    </div>
                    <div class="col-lg-4  col-md-6 col-sm-6">
                        <div class="single-gallery mb-30">
                            <div class="gallery-img size-img" style="background-image: url(../img/gallery/gallery4.png);"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--? Testimonial Start -->
        <div class="testimonial-area testimonial-padding section-bg" data-background="../img/gallery/section_bg03.png">
            <div class="container">
